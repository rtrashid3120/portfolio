...
import stackImage from '../assets/about/rashid-avatar.png';
import { aboutContent } from '../data/portfolioData';

// Tech stack SVG icons rendered inline for crisp rendering
const JavaIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20" viewBox="0 0 128 128">
    ...
    <span className="text-[10px] sm:text-xs font-bold text-white/70 uppercase tracking-wider">Java</span>
  </div>
);
...
const SpringBootIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[10px] sm:text-xs font-bold text-white/70 uppercase tracking-wider">Spring Boot</span>
  </div>
);
...
const MernIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[10px] sm:text-xs font-bold text-white/70 uppercase tracking-wider">MERN Stack</span>
  </div>
);

const About = () => {
  return (
    <section id="about" className="bg-[#ff2a2a] pt-40 md:pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            <div className="bg-gray-900 w-full max-w-[280px] rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="w-full aspect-[3/4] overflow-hidden rounded-xl bg-gray-800 border-2 border-transparent">
                <img 
                  src={stackImage} 
                  alt="Md Rashid — Full Stack Developer" 
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <div className="flex items-center gap-4 sm:gap-6 md:gap-10 mt-8">
